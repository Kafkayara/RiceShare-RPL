          ...
          <>
            <section className="mb-6 rounded-2xl border bg-white p-5 shadow-sm">
              <div className="mb-4 flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                <div>
                  <span className="mb-2 inline-block rounded-full border border-green-200 bg-green-50 px-3 py-1 text-xs font-medium text-green-700">
            ...
            <section className="grid grid-cols-1 gap-3 sm:grid-cols-2">
              <button
                ...
                className="rounded-xl border bg-white px-4 py-3 text-sm font-medium hover:bg-gray-50"
              >
                Buka Detail Lahan
              </button>
