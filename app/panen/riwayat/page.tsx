  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-green-50 via-lime-50 to-emerald-100 text-gray-900">
      ...
      <div className="mx-auto w-full max-w-6xl px-4 py-4 md:px-6 md:py-6">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            {isPengelola && (
              <button
                ...
                className="rounded-xl border border-green-200 bg-white px-4 py-2 text-sm font-medium text-black hover:bg-green-50"
              >
                + Input Panen
              </button>
            )}
        ...
        {/* FILTER */}
<section className="mb-6 rounded-3xl border border-green-100 bg-white/80 p-5 shadow-lg backdrop-blur-sm">
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
            ...
            <input
              ...
              className="rounded-xl border border-green-200 px-3 py-2 outline-none focus:border-green-500 focus:ring-2 focus:ring-green-500"
            />
...
<div>
  ...
  />
          ...
          <div className="mt-4 flex justify-end">
            <button
              onClick={resetFilter}
              className="rounded-xl border border-green-200 bg-white px-4 py-2 text-sm font-medium hover:bg-green-50 text-sm font-medium hover:bg-gray-50"
            >
              Reset Filter
            </button>
          </div>
        ...
        {loadingData ? (
          ...
          <section className="rounded-3xl border border-green-100 bg-white/80 p-5 shadow-lg backdrop-blur-sm">
            Loading...
          </section>

        ) : filteredPanen.length === 0 ? (

          <section className="rounded-3xl border border-green-100 bg-white/80 p-5 shadow-lg backdrop-blur-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
          ...
          <section className="grid grid-cols-1 gap-4 md:grid-cols-2">
            ...
            {filteredPanen.map((panen) => {
              ...
              return (
                <article
                  key={panen.id}
                  className="rounded-3xl border border-green-100 bg-white/80 p-5 shadow-lg backdrop-blur-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-xl"
                >
                  ...
                  <div className="mt-4 grid grid-cols-1 gap-2 sm:grid-cols-3">
                    ...
                    <button
                      ...
                      className="rounded-xl border border-green-200 bg-white px-4 py-2 text-sm font-medium hover:bg-green-50"
                    >
                      Detail
                    </button>
                    ...
                    <button
                      ...
                      className="rounded-xl bg-gradient-to-r from-green-500 to-emerald-600 px-4 py-2 text-sm font-semibold text-white shadow-md transition-all hover:scale-[1.02]"
                    >
                      Buka Laporan
                    </button>
      ...
      {selectedPanen && (
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 px-4">
          ...
          <div className="max-h-[92vh] w-full max-w-3xl overflow-y-auto rounded-3xl border border-green-100 bg-white p-6 shadow-2xl">
