...
export default function PengelolaPage() {
 ...
 useEffect(() => {
  ...
  setUser(dummyUser as UserProfile)
}, [router])
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-green-50 via-lime-50 to-emerald-100 text-gray-900">
      <div className="mx-auto w-full max-w-5xl px-4 py-6 md:px-6">
        ...
        {/* Header */}
        <header className="mb-6 flex flex-col gap-4 rounded-[30px] border border-green-100 bg-white/80 p-5 shadow-2xl backdrop-blur-xl md:flex-row md:items-center md:justify-between">
          <div>
  ...
  <span className="rounded-full bg-green-100 px-3 py-1 text-xs font-semibold text-green-700">
    👨‍🌾 Pemilik
          ...
          <div className="flex gap-2">
            <button onClick={handleTambah} className="rounded-xl border border-green-200 bg-white px-4 py-2 text-sm font-medium text-black hover:bg-green-50">
              + Tambah Pengelola
            </button>
            <button
        ...
        <div className="mb-4">
          <input
            ...
            className="w-full rounded-xl border border-green-200 bg-white px-4 py-2.5 text-sm shadow-sm focus:outline-none focus:ring-2 focus:ring-green-500"
          />
        </div>
        ...
        {loading ? (
          ...
          <section className="rounded-[30px] border border-green-100 bg-white/80 shadow-2xl backdrop-blur-xl">
            {/* Desktop */}
                ...
                <tbody className="divide-y">
                  {filteredPengelola.map((p) => (
                    <tr key={p.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-5 py-4">
                        <div className="flex gap-2">
                          <button onClick={() => handleEdit(p)} className="rounded-lg border border-green-200 bg-white px-3 py-1.5 text-xs font-medium text-black hover:bg-green-50">Edit</button>
          ...
          <div className="w-full max-w-md rounded-[30px] border border-green-100 bg-white p-6 shadow-2xl">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="rounded-xl border border-green-200 bg-gray-50 px-4 py-2.5 text-sm text-gray-500">Pengelola</div>
              </div>
              <div>
