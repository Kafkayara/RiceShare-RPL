  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-green-50 via-lime-50 to-emerald-100 text-gray-900">
      <div className="mx-auto w-full max-w-4xl px-4 py-4 md:px-6 md:py-6">
        <header className="mb-6 rounded-3xl border border-green-100 bg-white/80 p-5 shadow-lg backdrop-blur-sm md:flex md:items-center md:justify-between">
          <div>
            <p className="text-sm font-medium text-green-700">RiceShare</p>
            <h1 className="text-2xl font-bold">Mulai Tanam</h1>
            <p className="text-sm text-gray-500">
              Memulai musim tanam baru dan membuat jadwal siklus tanam.
            </p>
        ...
        {isPengelola && (
          <section className="rounded-3xl border border-green-100 bg-white/80 p-5 shadow-lg backdrop-blur-sm">
            {lahanList.length === 0 && (
              <div className="mb-4 rounded-2xl border border-amber-200 bg-amber-50 p-4 text-sm text-yellow-800">
            ...
            <form onSubmit={handleSubmit} className="space-y-4" noValidate>
              <div>
                ...
                <div className="relative">
                  <select
                    ref={lahanRef}
                    className={`w-full appearance-none rounded-xl border border-green-200 bg-white px-3 py-2 pr-10 outline-none focus:ring-2 ${
                      errors.lahanId
              ...
              <div>
                ...
                <input
                  ...
                  type="date"
                  max={today}
                  className={`w-full rounded-xl border border-green-200 px-3 py-2 outline-none focus:ring-2 ${
                    errors.tanggalMulai
                      ? "border-red-500 bg-red-50 focus:ring-red-500"
                      : "focus:ring-green-500"
                  }`}
            ...
            <div className="mt-4">
              ...
              <div className="space-y-2">
                {result.timeline.map((item) => (
                  <div
                    key={item.label}
                    className="rounded-2xl border border-green-100 bg-white p-3 shadow-sm"
                  >
